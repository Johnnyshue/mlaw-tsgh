...
const DOSDONTS = [
  ...
  // 11. 三班護病比 / 護理人力（2026 新法）
  {cat:'護病比', do:'護理人力不足時，主管要你補位 → 病歷寫「因護理人力暫缺由醫師執行 OOO」', dont:'被迫做護理工作但沒留任何書面紀錄', src:'醫療法 §12（2026）+ 醫師法 §28'},
  {cat:'護病比', do:'急診/病房塞不下 → 通報總醫師/科主任，病歷留紀錄', dont:'自己答應病人住院但實際塞不進去', src:'醫療法 §12（2026）'},
  {cat:'護病比', do:'護理交班錯誤高風險時刻（夜班/週末）→ 醫師雙重確認 read back', dont:'相信「護理會看著」就不主動 follow stat order', src:'最高法院 102 台上 3161 監督義務'},
  {cat:'護病比', do:'看到單位嚴重超標（例：地區醫院夜班 1:18）→ 醫院應改善，留意申訴管道', dont:'明知違法仍長期忽視，事後出醫糾無法主張系統性原因', src:'醫療法 §12 §102-1（2026）'},
];
